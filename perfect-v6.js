...
(function(){
  ...
  function renderMarquee(text){
    ...
    var repeated='';
    for(var i=0;i<5;i++){
      repeated+='<span data-marquee-item>'+text+'</span>';
    }

    track.innerHTML=
      '<div class="pf-marquee-group">'+repeated+'</div>'+
      '<div class="pf-marquee-group" aria-hidden="true">'+repeated+'</div>';
...
window.__AROMIKA_PERFECT_VERSION__='v6-final-cs-cart-linked';
