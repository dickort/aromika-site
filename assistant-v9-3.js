(function(){
'use strict';
if(window.__AROMIKA_ASSISTANT_V931__) return;
window.__AROMIKA_ASSISTANT_V931__=true;
...
function init(){var old=document.getElementById('aromika-assistant');if(old&&old.parentNode)old.parentNode.removeChild(old);preload();var root=shell();render(root);bindRoot(root);scheduleTeaser(root)}
