...
(function(){
  ...
  window.__AROMIKA_PERFECT_VERSION__='v9.2-laundry-mix';
  ...
  var data={
    laundry:{
      no:'01',
      ru:{title:'для стирки',lead:'Линейка гелей Perfect помогает подобрать средство под тип белья и привычный объём: Color для цветных тканей, Kids для детского белья, Black & Dark для тёмного, White для белого, Universal и ухаживающий вариант для повседневной стирки. В серии представлены форматы 1500, 3300 и 4300 мл.',series:'Стирка',marquee:'ЦВЕТНОЕ БЕЛЬЁ • ТЁМНЫЕ ТКАНИ • БЕЛОЕ БЕЛЬЁ • ДЕТСКАЯ СЕРИЯ • 1500 / 3300 / 4300 МЛ • PERFECT • '},
      kk:{title:'кір жууға арналған',lead:'Perfect гельдер желісі киім түрі мен қажетті көлемге сай құрал таңдауға көмектеседі: Color — түсті маталарға, Kids — балалар киіміне, Black & Dark — қою түсті киімге, White — ақ киімге, ал Universal және күтім жасайтын нұсқа күнделікті жууға арналған. Желіде 1500, 3300 және 4300 мл форматтары бар.',series:'Кір жуу',marquee:'ТҮСТІ КИІМ • ҚОЮ ТҮСТІ МАТАЛАР • АҚ КИІМ • БАЛАЛАР СЕРИЯСЫ • 1500 / 3300 / 4300 МЛ • PERFECT • '}
    },
    fabriccare:{
      no:'02',
