...
if(window.__AROMIKA_ASSISTANT_V953__) return;
window.__AROMIKA_ASSISTANT_V953__=true;
window.__AROMIKA_ASSISTANT_V952__=true;
window.__AROMIKA_ASSISTANT_V951__=true;
...
var PANEL_OPEN_KEY='aromika-romi-panel-open-v1';
var TEASER_KEY='aromika-assistant-v5-teaser-dismissed';
var BRAND_TEASER_PREFIX='aromika-assistant-brand-teaser-v1:';
var FEEDBACK_EMAIL='info@aromika.info';
var COOP_EMAIL='info@aromika.info';
var COMMERCE_OPEN_KEY='romi-v8-commerce-open-v1';

function scriptBase(){
  var src='';
  try{src=document.currentScript&&document.currentScript.src||''}catch(e){}
  if(!src){var list=document.getElementsByTagName('script');for(var i=list.length-1;i>=0;i--){if((list[i].src||'').indexOf('assistant-v9-5-3.js')>=0){src=list[i].src;break}}}
...
var TEXT={
 ru:{
  ...
  welcomeEyebrow:'Добро пожаловать',welcomeTitle:'Здравствуйте! Я — ROMI',welcomeSub:'Выберите удобный язык общения.',chooseLanguage:'Язык',ruLanguage:'Русский',kkLanguage:'Қазақша',
  purposeTitle:'С какой целью вы зашли на сайт?',purposeLead:'Выберите задачу — я предложу подходящие страницы.',purposeProducts:'Подобрать и купить продукцию',purposeProductsSub:'Средства для дома и личного ухода',purposeExplore:'Узнать о брендах и компании',purposeExploreSub:'Линейки Aromika, производство и история',purposePromos:'Найти акции',purposePromosSub:'Актуальные предложения и скидки',purposeBusiness:'Закупать для бизнеса или HoReCa',purposeBusinessSub:'Опт, торговые сети и профессиональные клиенты',purposeCoop:'Предложить сотрудничество',purposeCoopSub:'Дистрибуция бренда или предложение поставщика',purposeContacts:'Найти контакты или вакансии',purposeContactsSub:'Филиалы, центральный офис и работа в компании',recommendationsTitle:'Рекомендую начать отсюда',recommendationsLead:'Откройте подходящий раздел или перейдите в главное меню ROMI.',
  ...
  rep:'Связаться с представителем',repSub:'Прайс, сертификаты или визит торгового агента',partner:'Стать партнёром',partnerSub:'Закупка, HoReCa и дистрибуция',supplier:'Предложить сотрудничество',supplierSub:'Упаковка, сырьё, оборудование и услуги',review:'Оставить отзыв',reviewSub:'Оценка и комментарий прямо здесь',
  ...
  businessTitle:'Стать партнёром Aromika',businessLead:'Выберите направление — ROMI подготовит нужный способ связи.',businessRetail:'Закупка продукции Aromika',businessRetailSub:'Для торговых сетей, оптовых компаний и розничных клиентов',businessHoreca:'HoReCa и корпоративные клиенты',businessHorecaSub:'Поставки для регулярных профессиональных задач',businessDistribution:'Дистрибуция вашего бренда',businessDistributionSub:'Региональная система продаж для производителей и владельцев торговых марок',businessCityTitle:'Выберите город',businessCityRetailLead:'Покажем контакт торговой команды для обсуждения закупки.',businessCityHorecaLead:'Покажем контакт торговой команды для обсуждения поставок в HoReCa и для бизнеса.',businessDistributionTitle:'Предложить бренд для дистрибуции',businessDistributionLead:'ROMI подготовит письмо в центральный офис. Укажите категорию, бренд, территорию и формат сотрудничества.',
 ...
 kk:{
  ...
  welcomeEyebrow:'Қош келдіңіз',welcomeTitle:'Сәлеметсіз бе! Мен — ROMI',welcomeSub:'Қолайлы тілде сөйлесуді таңдаңыз.',chooseLanguage:'Тіл',ruLanguage:'Русский',kkLanguage:'Қазақша',
  purposeTitle:'Сайтқа қандай мақсатпен кірдіңіз?',purposeLead:'Міндетті таңдаңыз — мен қолайлы беттерді ұсынамын.',purposeProducts:'Өнімді таңдау және сатып алу',purposeProductsSub:'Үйге және жеке күтімге арналған құралдар',purposeExplore:'Брендтер мен компания туралы білу',purposeExploreSub:'Aromika желілері, өндіріс және тарих',purposePromos:'Акцияларды табу',purposePromosSub:'Өзекті ұсыныстар мен жеңілдіктер',purposeBusiness:'Бизнеске немесе HoReCa үшін сатып алу',purposeBusinessSub:'Көтерме сауда, сауда желілері және кәсіби клиенттер',purposeCoop:'Ынтымақтастық ұсыну',purposeCoopSub:'Бренд дистрибуциясы немесе жеткізуші ұсынысы',purposeContacts:'Байланыстарды немесе бос жұмыс орындарын табу',purposeContactsSub:'Филиалдар, орталық кеңсе және компаниядағы жұмыс',recommendationsTitle:'Осы жерден бастауды ұсынамын',recommendationsLead:'Қолайлы бөлімді ашыңыз немесе ROMI басты мәзіріне өтіңіз.',
  ...
  rep:'Өкілмен байланысу',repSub:'Прайс, сертификаттар немесе сауда агентінің келуі',partner:'Серіктес болу',partnerSub:'Сатып алу, HoReCa және дистрибуция',supplier:'Ынтымақтастық ұсыну',supplierSub:'Қаптама, шикізат, жабдық және қызметтер',review:'Пікір қалдыру',reviewSub:'Баға және пікір осы жерде',
  ...
  businessTitle:'Aromika серіктесі болу',businessLead:'Бағытты таңдаңыз — ROMI қажетті байланыс тәсілін дайындайды.',businessRetail:'Aromika өнімдерін сатып алу',businessRetailSub:'Сауда желілері, көтерме компаниялар және бөлшек клиенттер үшін',businessHoreca:'HoReCa және корпоративтік клиенттер',businessHorecaSub:'Тұрақты кәсіби міндеттерге арналған жеткізілімдер',businessDistribution:'Брендіңізді дистрибуциялау',businessDistributionSub:'Өндірушілер мен сауда маркасы иелеріне арналған өңірлік сату жүйесі',businessCityTitle:'Қаланы таңдаңыз',businessCityRetailLead:'Сатып алуды талқылау үшін сауда командасының байланысын көрсетеміз.',businessCityHorecaLead:'HoReCa және бизнеске жеткізілімді талқылау үшін сауда командасының байланысын көрсетеміз.',businessDistributionTitle:'Брендті дистрибуцияға ұсыну',businessDistributionLead:'ROMI орталық кеңсеге хат дайындайды. Санатты, брендті, аумақты және ынтымақтастық форматын көрсетіңіз.',
...
var VISIT_PURPOSES={
 products:{title:'purposeProducts',sub:'purposeProductsSub',links:[{href:'/brands',ru:'Посмотреть бренды',kk:'Брендтерді көру'},{href:'https://aromika.shop/',ru:'Открыть интернет-магазин',kk:'Интернет-дүкенді ашу',external:true}]},
 explore:{title:'purposeExplore',sub:'purposeExploreSub',links:[{href:'/brands',ru:'Бренды Aromika',kk:'Aromika брендтері'},{href:'/okompanii#company',ru:'Компания и производство',kk:'Компания және өндіріс'}]},
 promos:{title:'purposePromos',sub:'purposePromosSub',links:[{href:'/akcii',ru:'Актуальные акции',kk:'Өзекті акциялар'},{href:'https://aromika.shop/',ru:'Интернет-магазин',kk:'Интернет-дүкен',external:true}]},
 business:{title:'purposeBusiness',sub:'purposeBusinessSub',links:[{href:'/okompanii?type=retail#cooperation',ru:'Закупка продукции Aromika',kk:'Aromika өнімдерін сатып алу'},{href:'/okompanii?type=horeca#cooperation',ru:'HoReCa и корпоративным клиентам',kk:'HoReCa және корпоративтік клиенттерге'}]},
 cooperation:{title:'purposeCoop',sub:'purposeCoopSub',links:[{href:'/okompanii?type=distributor#cooperation',ru:'Дистрибуция вашего бренда',kk:'Брендіңізді дистрибуциялау'},{href:'/okompanii?type=supplier#cooperation',ru:'Предложение поставщика',kk:'Жеткізуші ұсынысы'}]},
 contacts:{title:'purposeContacts',sub:'purposeContactsSub',links:[{href:'/kontakty',ru:'Контакты и филиалы',kk:'Байланыстар мен филиалдар'},{href:'/careers',ru:'Работа в компании',kk:'Компаниядағы жұмыс'}]}
};
...
function syncCooperationNavigation(){
 var l=lang(),label=l==='kk'?'Ынтымақтастық':'Сотрудничество',href='/okompanii#cooperation';
 document.querySelectorAll('#aromika-hero .ar-nav a[data-i18n="about"],#aromika-hero .ar-menu a[data-i18n="about"],#aromika-hero a[data-ar-common="about"]').forEach(function(a){
  if(a.textContent!==label)a.textContent=label;
  if(a.getAttribute('href')!==href)a.setAttribute('href',href);
 });
 document.querySelectorAll('#aromika-footer a[data-arf-i18n="about"],#aromika-footer a[href="/okompanii"],#aromika-footer a[href="/okompanii#cooperation"]').forEach(function(a){
  if(a.textContent!==label)a.textContent=label;
  if(a.getAttribute('href')!==href)a.setAttribute('href',href);
 });
}
...
function homeOrder(){var c=context();if(c==='brand')return['finder','shop','sale','rep','partner','supplier','review'];if(c==='promo')return['shop','finder','brands','rep','partner','review'];if(c==='company')return['rep','partner','supplier','finder','shop','review'];if(c==='contacts')return['rep','shop','partner','supplier','review'];if(c==='vacancy')return['work','contacts','brands','shop','review'];if(c==='production')return['production','brands','partner','supplier','contacts','review'];return['finder','shop','sale','brands','rep','partner','supplier','review']}
...
function actionMeta(k,t){var map={finder:[t.finder,t.finderSub,'finder'],shop:[t.shop,t.shopSub,'shop'],sale:[t.sale,t.saleSub,'sale'],brands:[t.brands,t.brandsSub,'brands'],rep:[t.rep,t.repSub,'rep'],partner:[t.partner,t.partnerSub,'partner'],supplier:[t.supplier,t.supplierSub,'partner'],review:[t.review,t.reviewSub,'review'],contacts:[t.contacts,t.contactsSub,'contact'],work:[t.work,t.workSub,'work'],production:[t.production,t.productionSub,'production']};return map[k]}
...
function renderVisitPurpose(root,t){return '<div class="aa-stage-visual aa-stage-visual--compact">'+romiHTML('greeting','aa-romi--stage')+'</div>'+screenHead(t.welcomeEyebrow,t.purposeTitle,t.purposeLead,t,'launcher')+'<div class="aa-body"><div class="aa-choice-grid">'+Object.keys(VISIT_PURPOSES).map(function(key){var p=VISIT_PURPOSES[key];return '<button class="aa-choice" type="button" data-aa-visit-purpose="'+key+'"><b>'+esc(t[p.title])+'</b><span>'+esc(t[p.sub])+'</span><i>→</i></button>'}).join('')+'</div></div>'}
function renderVisitRecommendations(root,t,l){var p=VISIT_PURPOSES[state.visitPurpose]||VISIT_PURPOSES.products;return '<div class="aa-success-visual">'+romiHTML('success','aa-romi--success')+'</div>'+screenHead(t[p.title],t.recommendationsTitle,t.recommendationsLead,t,'launcher')+'<div class="aa-body"><div class="aa-brand-list">'+p.links.map(function(link){return '<a class="aa-brand-link" href="'+esc(link.href)+'"'+(link.external?' target="_blank" rel="noopener"':'')+'><b>'+esc(link[l]||link.ru)+'</b><span>→</span></a>'}).join('')+'</div><button class="aa-simple-button aa-simple-button--wide" type="button" data-aa-home>'+esc(t.home)+'</button></div>'}
...
function representativeMessage(purpose,city,l){var c=cityLabel(city,l);if(l==='kk'){if(purpose==='price')return'Сәлеметсіз бе! Мен '+c+' қаласынан хабарласып тұрмын. Aromika-ның өзекті прайс-парағын алғым келеді.';if(purpose==='certificates')return'Сәлеметсіз бе! Мен '+c+' қаласынан хабарласып тұрмын. Aromika өнімдерінің сертификаттары мен құжаттарын сұратқым келеді.';if(purpose==='agent')return'Сәлеметсіз бе! Мен '+c+' қаласынан хабарласып тұрмын. Сауда нүктесіне Aromika сауда агентін шақырғым келеді.';if(purpose==='retail')return'Сәлеметсіз бе! Мен '+c+' қаласынан хабарласып тұрмын. Aromika өнімдерін сатып алу шарттарын талқылағым келеді.';if(purpose==='horeca')return'Сәлеметсіз бе! Мен '+c+' қаласынан хабарласып тұрмын. Бизнес / HoReCa үшін Aromika өнімдерін жеткізуді талқылағым келеді.';return'Сәлеметсіз бе! Мен '+c+' қаласынан хабарласып тұрмын. Aromika өкілімен байланысқым келеді.'}if(purpose==='price')return'Здравствуйте! Я нахожусь в городе '+c+'. Хочу получить актуальный прайс-лист Aromika.';if(purpose==='certificates')return'Здравствуйте! Я нахожусь в городе '+c+'. Хочу запросить сертификаты и документы на продукцию Aromika.';if(purpose==='agent')return'Здравствуйте! Я нахожусь в городе '+c+'. Хочу пригласить торгового агента Aromika в торговую точку.';if(purpose==='retail')return'Здравствуйте! Я нахожусь в городе '+c+'. Хочу обсудить закупку продукции Aromika.';if(purpose==='horeca')return'Здравствуйте! Я нахожусь в городе '+c+'. Хочу обсудить поставки Aromika для бизнеса / HoReCa.';return'Здравствуйте! Я нахожусь в городе '+c+'. Хочу связаться с представителем Aromika.'}
function contactCard(s,t,l,city,purpose){var buttons='<div class="aa-contact-actions"><a href="tel:'+esc(s.tel)+'">'+esc(t.call)+'</a>';if(s.wa){var wa='https://wa.me/'+s.wa+'?text='+encodeURIComponent(representativeMessage(purpose||state.repPurpose,city,l));buttons+='<a href="'+esc(wa)+'" target="_blank" rel="noopener">'+esc(t.whatsapp)+'</a>'}if(s.email)buttons+='<a href="mailto:'+esc(s.email)+'">'+esc(t.email)+'</a>';buttons+='</div>';return '<article class="aa-contact"><small>'+esc(cityLabel(s.city,l))+'</small><b>'+esc(s.name)+'</b><span>'+esc(roleLabel(s.role,t))+'</span><a class="aa-phone" href="tel:'+esc(s.tel)+'">'+esc(s.phone)+'</a>'+buttons+'</article>'}
function renderContacts(root,city,t,l){var holder=root.querySelector('.aa-contact-results');if(!holder)return;if(!city){holder.innerHTML='';return}var list=city==='Костанай'?[BRANCH_FALLBACK]:SALES.filter(function(s){return s.city===city});holder.innerHTML=list.length?list.map(function(s){return contactCard(s,t,l,city,state.repPurpose)}).join(''):'<p class="aa-note">'+esc(t.noRep)+'</p><a class="aa-simple-link" href="/kontakty">'+esc(t.allContacts)+' <span>→</span></a>'}
...
var BUSINESS_TYPES={retail:['businessRetail','businessRetailSub'],horeca:['businessHoreca','businessHorecaSub'],distribution:['businessDistribution','businessDistributionSub']};
function renderBusinessPartner(root,t){return '<div class="aa-stage-visual aa-stage-visual--compact">'+romiHTML('greeting','aa-romi--stage')+'</div>'+screenHead(t.kicker,t.businessTitle,t.businessLead,t,'launcher')+'<div class="aa-body"><div class="aa-choice-grid">'+Object.keys(BUSINESS_TYPES).map(function(type){var keys=BUSINESS_TYPES[type];return '<button class="aa-choice" type="button" data-aa-business-type="'+type+'"><b>'+esc(t[keys[0]])+'</b><span>'+esc(t[keys[1]])+'</span><i>→</i></button>'}).join('')+'</div></div>'}
function renderBusinessContacts(root,t,l){var opts=cities().map(function(c){return '<option value="'+esc(c)+'"'+(state.businessCity===c?' selected':'')+'>'+esc(cityLabel(c,l))+'</option>'}).join(''),lead=state.businessType==='horeca'?t.businessCityHorecaLead:t.businessCityRetailLead;return '<div class="aa-stage-visual aa-stage-visual--compact">'+romiHTML('greeting','aa-romi--stage')+'</div>'+screenHead(t.kicker,t.businessCityTitle,lead,t,'launcher')+'<div class="aa-body"><label class="aa-field"><span class="aa-field-label">'+esc(t.city)+'</span><span class="aa-select-wrap"><select id="aa-business-city" class="aa-select"><option value="">'+esc(t.chooseCity)+'</option>'+opts+'</select></span></label><div class="aa-business-contact-results"></div><a class="aa-simple-link" href="/kontakty">'+esc(t.allContacts)+' <span>→</span></a></div>'}
function renderBusinessResults(root,city,t,l){var holder=root.querySelector('.aa-business-contact-results');if(!holder)return;if(!city){holder.innerHTML='';return}var list=city==='Костанай'?[BRANCH_FALLBACK]:SALES.filter(function(s){return s.city===city});holder.innerHTML=list.length?list.map(function(s){return contactCard(s,t,l,city,state.businessType)}).join(''):'<p class="aa-note">'+esc(t.noRep)+'</p><a class="aa-simple-link" href="/kontakty">'+esc(t.allContacts)+' <span>→</span></a>'}
function renderBusinessDistribution(root,t,l){var subject=l==='kk'?'Брендті Aromika дистрибуциясына ұсыну':'Предложить бренд для дистрибуции Aromika',body=l==='kk'?'Сәлеметсіз бе!\n\nБрендті Aromika дистрибуциясына ұсынғым келеді.\n\nКомпания:\nБренд және санат:\nАумақ:\nЫнтымақтастық форматы:\nБайланыс деректері:\n':'Здравствуйте!\n\nХочу предложить бренд для дистрибуции Aromika.\n\nКомпания:\nБренд и категория:\nТерритория:\nФормат сотрудничества:\nКонтактные данные:\n',mailto='mailto:'+COOP_EMAIL+'?subject='+encodeURIComponent(subject)+'&body='+encodeURIComponent(body);return '<div class="aa-stage-visual aa-stage-visual--compact">'+romiHTML('success','aa-romi--stage')+'</div>'+screenHead(t.businessDistribution,t.businessDistributionTitle,t.businessDistributionLead,t,'launcher')+'<div class="aa-body"><a class="aa-action aa-action--primary" href="'+esc(mailto)+'"><span class="aa-action-icon">'+ICONS.contact+'</span><span class="aa-action-copy"><b>'+esc(t.prepareEmail)+'</b><small>'+esc(COOP_EMAIL)+'</small></span><span class="aa-arrow">→</span></a><a class="aa-simple-link" href="tel:+77142524044">'+esc(t.centralPhone)+' <span>→</span></a></div>'}
...
var DEFAULT_STATE={screen:'welcome',history:[],visitPurpose:'',finderCategory:'',finderNeed:'',finderVolume:'',repPurpose:'',repCity:'',businessType:'',businessCity:'',coopType:'',rating:0};
function hasChosenRomiLanguage(){try{return !!localStorage.getItem(ROMI_LANG_KEY)}catch(e){return false}}
function hasCompletedOnboarding(){try{return localStorage.getItem(ONBOARDING_KEY)==='1'}catch(e){return false}}
function loadState(){
 var saved=null;
 try{saved=JSON.parse(localStorage.getItem(UI_STATE_KEY)||'null')}catch(e){}
 var next=Object.assign({},DEFAULT_STATE,saved&&typeof saved==='object'?saved:{});
 if(!Array.isArray(next.history))next.history=[];
 next.history=next.history.slice(-8);
 var allowed=['welcome','visitPurpose','visitRecommendations','home','finder','finderNeeds','finderVolumes','finderResult','repRequest','rep','businessPartner','businessContacts','businessDistribution','partner','partnerContact','feedback','feedbackSuccess'];
 if(allowed.indexOf(next.screen)<0)next.screen='home';
 if(!hasChosenRomiLanguage())next.screen='welcome';
 else if(!hasCompletedOnboarding())next.screen='visitPurpose';
 else if(next.screen==='welcome'||next.screen==='visitPurpose')next.screen='home';
 return next;
}
function saveState(){
 try{localStorage.setItem(UI_STATE_KEY,JSON.stringify({
  ...
  visitPurpose:state.visitPurpose||'',finderCategory:state.finderCategory||'',finderNeed:state.finderNeed||'',finderVolume:state.finderVolume||'',
  repPurpose:state.repPurpose||'',repCity:state.repCity||'',businessType:state.businessType||'',businessCity:state.businessCity||'',coopType:state.coopType||'',
  rating:Number(state.rating)||0,updated_at:Date.now()
 }))}catch(e){}
}
var state=loadState();
...
function render(root){var l=lang(),t=TEXT[l],screen=root.querySelector('.aa-screen'),info=brandTeaser(l),teaser=root.querySelector('.aa-teaser');teaser.classList.toggle('aa-teaser--info',!!info);teaser.style.cursor=info?'default':'';teaser.querySelector('strong').textContent=info?info.title:t.teaserTitle;teaser.querySelector('p').textContent=info?info.text:t.teaserText;root.querySelector('.aa-foot').textContent=t.foot;root.querySelector('.aa-back span').textContent=t.back;root.querySelector('.aa-back').classList.toggle('is-visible',state.screen!=='home'&&state.screen!=='welcome'&&state.screen!=='visitPurpose');root.querySelector('.aa-panel-close').setAttribute('aria-label',t.close);if(state.screen==='welcome')screen.innerHTML=renderWelcome(root,t);else if(state.screen==='visitPurpose')screen.innerHTML=renderVisitPurpose(root,t);else if(state.screen==='visitRecommendations')screen.innerHTML=renderVisitRecommendations(root,t,l);else if(state.screen==='home')screen.innerHTML=renderHome(root,t);else if(state.screen==='finder')screen.innerHTML=renderFinder(root,t);else if(state.screen==='finderNeeds')screen.innerHTML=renderFinderNeeds(root,t);else if(state.screen==='finderVolumes')screen.innerHTML=renderFinderVolumes(root,t);else if(state.screen==='finderResult')screen.innerHTML=renderFinderResult(root,t);else if(state.screen==='repRequest')screen.innerHTML=renderRepRequest(root,t);else if(state.screen==='rep')screen.innerHTML=renderRep(root,t,l);else if(state.screen==='businessPartner')screen.innerHTML=renderBusinessPartner(root,t);else if(state.screen==='businessContacts')screen.innerHTML=renderBusinessContacts(root,t,l);else if(state.screen==='businessDistribution')screen.innerHTML=renderBusinessDistribution(root,t,l);else if(state.screen==='partner')screen.innerHTML=renderPartner(root,t);else if(state.screen==='partnerContact')screen.innerHTML=renderPartnerContact(root,t,l);else if(state.screen==='feedback')screen.innerHTML=renderFeedback(root,t);else if(state.screen==='feedbackSuccess')screen.innerHTML=renderFeedbackSuccess(root,t);else{state.screen='home';saveState();screen.innerHTML=renderHome(root,t)}syncCooperationNavigation();bindScreen(root,t,l)}
function bindScreen(root,t,l){
 ...
 root.querySelectorAll('[data-aa-visit-purpose]').forEach(function(el){el.addEventListener('click',function(){var purpose=el.getAttribute('data-aa-visit-purpose')||'products';state.visitPurpose=VISIT_PURPOSES[purpose]?purpose:'products';try{localStorage.setItem(ONBOARDING_KEY,'1')}catch(e){}emit('visit_purpose',{purpose:state.visitPurpose});gotoScreen(root,'visitRecommendations',{visitPurpose:state.visitPurpose})})});
 root.querySelectorAll('[data-aa-action]').forEach(function(el){el.addEventListener('click',function(e){var k=el.getAttribute('data-aa-action');emit(k);if(k==='finder'){e.preventDefault();gotoScreen(root,'finder')}else if(k==='rep'){e.preventDefault();gotoScreen(root,'repRequest',{repPurpose:'',repCity:''})}else if(k==='partner'){e.preventDefault();gotoScreen(root,'businessPartner',{businessType:'',businessCity:''})}else if(k==='supplier'){e.preventDefault();gotoScreen(root,'partner',{coopType:''})}else if(k==='review'){e.preventDefault();gotoScreen(root,'feedback')}})});
 ...
 root.querySelectorAll('[data-aa-business-type]').forEach(function(el){el.addEventListener('click',function(){var type=el.getAttribute('data-aa-business-type')||'retail';emit('business_direction',{direction:type});if(type==='distribution')gotoScreen(root,'businessDistribution',{businessType:type,businessCity:''});else gotoScreen(root,'businessContacts',{businessType:type,businessCity:''})})});
 ...
 var businessSelect=root.querySelector('#aa-business-city');if(businessSelect){businessSelect.addEventListener('change',function(){state.businessCity=this.value;saveState();renderBusinessResults(root,this.value,t,l);emit('business_city',{city:this.value,direction:state.businessType})});if(state.businessCity)renderBusinessResults(root,state.businessCity,t,l)}
...
function bindRoot(root){
 ...
 function setOpenFlag(value){try{sessionStorage.setItem(PANEL_OPEN_KEY,value?'1':'0')}catch(e){}}
 ...
 function closeCommerce(){root.classList.remove('is-rv8');var layer=root.querySelector('.rv81-layer,.rv8-layer');if(layer)layer.classList.remove('is-active');try{sessionStorage.setItem(COMMERCE_OPEN_KEY,'0')}catch(e){}}
 function openScenario(scenario){closeCommerce();state.history=['home'];if(scenario==='representative'){state.screen='repRequest';state.repPurpose='';state.repCity='';emit('external_representative')}else if(scenario==='cooperation'||scenario==='supplier'){state.screen='partner';state.coopType='';emit('external_supplier')}else if(scenario==='partnership'){state.screen='businessPartner';state.businessType='';state.businessCity='';emit('external_partnership')}else if(scenario==='partnership-retail'||scenario==='partnership-horeca'){state.screen='businessContacts';state.businessType=scenario==='partnership-horeca'?'horeca':'retail';state.businessCity='';emit('external_partnership',{direction:state.businessType})}else if(scenario==='partnership-distribution'){state.screen='businessDistribution';state.businessType='distribution';state.businessCity='';emit('external_partnership',{direction:'distribution'})}else return;saveState();render(root);scrollPanelTop(root);open()}
 ...
 try{if(sessionStorage.getItem(PANEL_OPEN_KEY)==='1')open(false)}catch(e){}
}
