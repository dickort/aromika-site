(function(){
'use strict';
if (window.__ROMI_V952_LOADER__) return;
window.__ROMI_V952_LOADER__ = true;
...
function loadIntegratedCore(){
  ...
  s.src = 'https://aromika.shop/js/addons/romi_connector/romi-chat-v10-core.js?v=10.0.37';
  s.async = false;
  s.defer = true;
  s.setAttribute('data-romi-core', 'v9.5.2-site-knowledge');
